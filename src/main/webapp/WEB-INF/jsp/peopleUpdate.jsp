...
<li>  			<a href="j_spring_security_logout"><span class="glyphicon glyphicon-log-out"></span> <spring:message code="logout"/> </a> 
	...
	<div id="formAddPeople">
		<form:form role="form" modelAttribute="people"
			...
			<div class="form1">
				<form:input path="idPeople" class="" hidden="true"/>
				...
				<div class="form-group" id="inpAddPeople">
                    ...
                    <br/></div>
                    <div class="form-group">
					 <a href="userView.html"><button type="button"
							class="btn w3-lightgray"><spring:message code="back"/></button></a>
					<button class="btn mc-blue" id="btn-next-people" type="button"><spring:message code="next"/></button>
				</div>
			</div>

			<div id="form2">
				<form:form role="form" name="myFormPhone" modelAttribute="phone"
					method="post">
					<div class="form2">
						<div id="divform2">
							<div class="form-group" id="inpAddPeople">

								<form:input path="idp" id="phone-id-0" hidden="true"/>

								<label><spring:message code="phoneNumber" /> </label>
								<form:input type="number" class="form-control "
									id="phone-number-0" placeholder="" path="number" value="" />
								<form:errors class="error" path="number"></form:errors>
							</div>

							<div class="form-group" id="inpAddPeople">
								<form:select id="category-0" path="categoryPh" value=""
									class="btn mc-blue">
						...
						<div id="foreachformphone"></div>
						<div id="formPhone"></div>
						<button type="button" class="btn mc-blue"
							onClick="phoneFunction()">+</button>
						<br /> <br />
						<button class="btn w3-lightgray lightgray" id="btn-back-phone" type="button"><spring:message code="back"/></button>
						...
						<form:form role="form" modelAttribute="address" method="post">
							<div class="form3">
								<div id="divform3">
									...
									<div class="form-group" id="inpAddPeople">
										<form:select id="category" path="categoryA"
											class="btn mc-blue">
											<form:option value="HOME">
												<spring:message code="HOME" />
											</form:option>
								...
								<div id="foreachformaddress"></div>
								<div id="formAddress"></div>

								<button type="button" onClick="addressFunction()"
									class="btn mc-blue">+</button>
								<br /> <br />
								<button class="btn w3-lightgray lightgray" id="btn-back-address"
									type="button"><spring:message code="back"/></button>
								<button class="btn mc-blue" id="btn-next-address"
									type="button"><spring:message code="next"/></button>

							</div>

							<div id="form4">
								<form:form role="form" modelAttribute="mail" method="post"
									id="form-email" action="peopleUpdate.html">
									<div class="form4">
										<div id="divform4">
											...
											<div class="form-group" id="inpAddPeople">
												<form:select id="category" path="categoryM"
													class="btn mc-blue">
													<form:option value="HOME">
														<spring:message code="HOME" />
													</form:option>
										...
										<div id="foreachformmail"></div>

										<div id="emailForm"></div>

										<button type="button" class="btn mc-blue"
											onClick="emailFunction()">+</button>
										<br /> <br />
										<button class="btn w3-lightgray lightgray" id="btn-back-email"
											type="button"><spring:message code="back"/></button>
										<button type="button" class="btn mc-blue" id="btn-submit" onClick="validate()">
	...
	<div id="foreach">
		<c:forEach items="${phones}" var="phone">
			<div>
				<form:form role="form" name="myFormPhone" modelAttribute="phone"
					method="post">
					<div class="formForeachphone">
						<div class="form-group">
							
							<form:input hidden="true" path="idp" id="phone-id-${phone.idPhoneNumber}"
								value="${phone.idPhoneNumber}" />
							<label><spring:message code="phoneNumber" /> </label>
							<form:input type="number" class="form-control "
								id="phone-number-${phone.idPhoneNumber}" placeholder=""
								path="number" value="${phone.number}" />
							<form:errors class="error" path="number"></form:errors>
						</div>

						<div class="form-group">
							<form:select path="categoryPh" class="btn mc-blue">
								<form:option value="HOME">
									<spring:message code="HOME" />
								</form:option>
								<form:option value="WORK">
		...
		<c:forEach items="${addresss}" var="addresss">
			<div>
				<form:form role="form" modelAttribute="address" method="post">
					<div class="formForeachaddress">
						<label> <spring:message code="address" />
						</label> 
						<form:input hidden="true" path="ida" id="" value="${addresss.idAddress}" />
						<div class="form-group" id="inpAddPeople">
							<label><spring:message code="street" /> </label>
							<form:input type="text" class="form-control inputs" placeholder=""
								path="street" value="${addresss.street}" />
								<p class="demo1"></p>
							<form:errors class="error" path="street"></form:errors>
						</div>
						<div class="form-group" id="inpAddPeople">
						...
						<div class="form-group" id="inpAddPeople">
							<label for="email"><spring:message code="state" /> </label>
							<form:input type="text" class="form-control inputs" placeholder=""
								path="state" value="${addresss.state}" />
								<p class="demo1"></p>
							<form:errors class="error" path="state"></form:errors>
						</div>
						<div class="form-group" id="inpAddPeople">
		...
		<c:forEach items="${mails}" var="mail">
			...
			<div>
				<form:form role="form" modelAttribute="mail" method="post"
					id="form-email">
					<div class="formForeachmail">
						<label><spring:message code="mail" /> </label> 
						<form:input path="idm" value="${mail.idMail}"  hidden="true"/>
						<div class="form-group" id="inpAddPeople">
							<label for="email"><spring:message code="email" /> </label>
							<form:input type="email" class="form-control" placeholder=""
								path="email" value="${mail.email}" />
						</div>
						<div class="form-group" id="inpAddPeople">
...
<script type="text/javascript">
		 ...
		 var sizePhone = ${sizePhone};
		 var sizeAddress = ${sizeAddress};
		 var sizeMail = ${sizeMail};

		 if (sizePhone != 0) {
		 document.getElementById("divform2").remove();
		 var formphone = document.getElementsByClassName("formForeachphone");
		 var x = "";
		 for (var i = 0; i < formphone.length; i++) {
		 x += formphone[i].innerHTML;
		 document.getElementById("foreachformphone").innerHTML = x;
		 }
		 }
		
		 if(sizeAddress != 0) {
		 document.getElementById("divform3").remove();
		 var formaddress = document.getElementsByClassName("formForeachaddress");
		 var x = "";
		 for(var i = 0; i < formaddress.length; i++) {
		 x += formaddress[i].innerHTML;
		 document.getElementById("foreachformaddress").innerHTML = x;
		 }
		 }

		 if(sizeMail != 0) {
		 document.getElementById("divform4").remove();
		 var formmail = document.getElementsByClassName("formForeachmail");
		 var x = "";
		 for (var i = 0; i < formmail.length; i++) {
		 x += formmail[i].innerHTML;
		 document.getElementById("foreachformmail").innerHTML = x;
		 }
		 }
		 document.getElementById("foreach").remove();
